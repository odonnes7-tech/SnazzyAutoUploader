...
4. brand: the brand name if visible on the item or label (e.g. "Nike", "Levi's", "Ralph Lauren"). Leave empty string if not identifiable.
5. condition: pick from: Brand new, Like new, Used - Excellent, Used - Good, Used - Fair
6. color: pick the single best match from: Black, Grey, White, Brown, Tan, Cream, Yellow, Red, Pink, Orange, Purple, Blue, Navy, Green, Khaki, Multicolour
7. source: pick from: Vintage, Preloved, Reworked / Upcycled, Custom, Handmade, Deadstock, Designer, Repaired
8. age: pick from: Modern, 00s, 90s, 80s, 70s, 60s, 50s, Antique
9. style: pick the single best match from: Streetwear, Sportswear, Loungewear, Goth, Retro, Boho, Western, Indie, Skater, Preppy, Minimalist, Y2K, Grunge, Classic
10. package_size: estimate the shipping package size based on the item type. Pick from: Extra Small, Small, Medium, Large, Extra Large

Return ONLY a JSON object with keys: name, description, category, brand, condition, color, source, age, style, package_size. Values must exactly match one of the options listed above (except brand which is free text).`,
      file_urls: [file_url],
